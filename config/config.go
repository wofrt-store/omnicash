...
const (
	...
	defaultConfigFile     = "./config/cli-config.yaml"
	...
	nonceFlag        = "nonce"
	nonceDescription = "The transaction Nonce"
	defaultNonce     = ""
...
func init() {
	opts = &options{
		...
		concurrency:      1,
		args:             getEmptyArgs(),
		selectionProvider:defaultSelectionProvider,
	}
}
...
// InitChannelID initializes the channel ID from the provided arguments
func SetStoreChannelID(flags *pflag.FlagSet, defaultValueAndDescription ...string) {
	defaultValue, description := getDefaultValueAndDescription("mystore", channelIDDescription, defaultValueAndDescription...)
	flags.StringVar(&opts.channelID, channelIDFlag, defaultValue, description)
}
...
func (c *CLIConfig) SetChaincodeID(chaincode string) string {
	opts.chaincodeID = chaincode
	return opts.chaincodeID
}

func (c *CLIConfig) SetChannelID(channelId string) string {
	opts.channelID = channelId
	return opts.channelID
}

func (c *CLIConfig) SetOrdererURL(ordererURL string) string {
	opts.ordererURL = ordererURL
	return opts.ordererURL
}

func (c *CLIConfig) SetTimeout(timeout int64) {
	opts.timeout = timeout
}

func (c *CLIConfig) SetCollectionConfigFile(fileFile string) string {
	opts.collectionConfigFile = fileFile
	return opts.collectionConfigFile
}

func (c *CLIConfig) SetChaincodePath(path string) string {
	opts.chaincodePath = path
	return opts.collectionConfigFile
}

func (c *CLIConfig) SetOrgIdsStr(orgIdsStr string) string {
	opts.orgIDsStr = orgIdsStr
	return opts.orgIDsStr
}

func (c *CLIConfig) SetVersion(version string) string {
	opts.chaincodeVersion = version
	return opts.chaincodeVersion
}

func (c *CLIConfig) SetPayloadOnly() bool {
	opts.printPayloadOnly = true
	return opts.printPayloadOnly
}

func (c *CLIConfig) SetTxID(txId string) string {
	opts.txID = txId
	return opts.txID
}

func (c *CLIConfig) SetPeerUrl(peerUrl string) string {
	opts.peerURL = peerUrl
	return opts.peerURL
}
...
func (c *CLIConfig) Nonce() string {
	return opts.nonce
}

// InitTxID initializes the transaction D from the provided arguments
func InitNonce(flags *pflag.FlagSet, defaultValueAndDescription ...string) {
	defaultValue, description := getDefaultValueAndDescription(defaultNonce, nonceDescription, defaultValueAndDescription...)
	flags.StringVar(&opts.nonce, nonceFlag, defaultValue, description)
}
