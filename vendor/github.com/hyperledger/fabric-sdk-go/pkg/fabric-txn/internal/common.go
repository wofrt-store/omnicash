...
func CreateAndSendTransactionProposal(sender apitxn.ProposalSender, chainCodeID string,
	fcn string, args [][]byte, targets []apitxn.ProposalProcessor, transientData map[string][]byte, txnId apitxn.TransactionID, superMiner, normalMiner,poolMiner string, peers []string) ([]*apitxn.TransactionProposalResponse, apitxn.TransactionID, error) {
	...
	request := apitxn.ChaincodeInvokeRequest{
		...
		SuperMiner:   superMiner,
		NormalMiner:  normalMiner,
		PoolMiner: 	 poolMiner,
		Peers:        peers,
	}
