...
type SerializedIdentity struct {
	...
	// 超级节点矿工
	SuperMiner string `protobuf:"bytes,3,opt,name=super_miner,json=superMiner" json:"super_miner,omitempty"`
	// 普通节点矿工
	NormalMiner string `protobuf:"bytes,4,opt,name=normal_miner,json=normalMiner" json:"normal_miner,omitempty"`
}
...
func (m *SerializedIdentity) GetSuperMiner() string {
	if m != nil {
		return m.SuperMiner
	}
	return ""
...
func (m *SerializedIdentity) GetNormalMiner() string {
	if m != nil {
		return m.NormalMiner
	}
	return ""
}
